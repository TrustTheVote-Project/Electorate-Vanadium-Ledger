...
export class LedgerStack extends cdk.Stack {
  ...
  constructor(scope: cdk.Construct, id: string, props?: cdk.StackProps) {
    ...
    const memberAdminPasswordName = cdk.Fn.importValue('LedgerMemberAdminPasswordSecretName');
    const memberAdminPasswordArn = `arn:aws:secretsmanager:${region}:${account}:secret:${memberAdminPasswordName}`
    const memberAdminPassword = secretsmanager.Secret.fromSecretAttributes(this, 'MemberAdminPassword', {
      secretCompleteArn: memberAdminPasswordArn,
